    ...
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar p-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link active" href="${pageContext.request.contextPath}/user/categories">
            ...
            <div class="row g-4">
                <c:forEach var="c" items="${cats}">
                    <div class="col-sm-6 col-lg-4">
                        <div class="card category-card h-100 border-0 shadow-sm card-hover">
                            <div class="card-body text-center">
                                <i class="fas fa-book text-primary mb-3 fa-2x"></i>
                                <h5 class="card-title">${c.titre}</h5>
                                <a href="${pageContext.request.contextPath}/user/livres/${c.id}"
