    ...
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar p-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link active" href="${pageContext.request.contextPath}/admin/livres">
        ...
        <main class="col-md-10 ms-sm-auto content">
            <div class="row g-4">
                <div class="container py-3">
                    <h2 class="text-center text-primary mb-4">Gestion des Livres</h2>
                    <a href="${pageContext.request.contextPath}/admin/ajouter-livre" class="btn btn-outline-primary btn-sm mb-3">
                            ...
                            <table class="table table-bordered align-middle bg-white shadow-sm">
                                ...
                                <c:forEach items="${livres}" var="livre">
                                    <tr>
                                        <td>${livre.titre}</td>
                                        <td>${livre.auteur}</td>
                                        <td>${livre.cat.titre}</td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/admin/supprimer-livre/${livre.id}"
