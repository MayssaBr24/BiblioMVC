    ...
    <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar p-3">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link" href="${pageContext.request.contextPath}/user/emprunt">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card card-hover border-0 shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title"><i class="fas fa-book-open me-2 text-primary"></i>Livres par catégorie</h5>
                            <p class="card-text">Consulter tous les livres classés par catégorie.</p>
                            <a href="${pageContext.request.contextPath}/user/categories" class="btn btn-outline-primary">Voir</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card card-hover border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <a href="${pageContext.request.contextPath}/user/emprunt" class="btn btn-outline-success">Voir</a>
                        </div>
                    </div>
                </div>
            </div>
